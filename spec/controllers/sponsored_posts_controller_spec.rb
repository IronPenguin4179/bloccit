...
RSpec.describe SponsoredPostsController, type: :controller do
  ...
  describe "POST create" do
    it "increases the number of SponsoredPosts by 1" do
      expect{post :create, params: { topic_id: my_topic.id, sponsored_post: {title: RandomData.random_sentence, body: RandomData.random_paragraph, price: 999 } } }.to change(SponsoredPost,:count).by(1)
    end
    
    it "assigns the new post to @sponsored_post" do
      post :create, params: { topic_id: my_topic.id, sponsored_post: { title: RandomData.random_sentence, body: RandomData.random_paragraph, price: 999 } }
  ...
  describe "PUT update" do
    it "updates sponsored post with expected attributes" do
      ...
      put :update, params: { topic_id: my_topic.id, id: my_sponsored_post, sponsored_post: {title: new_title, body: new_body, price: 999} }
    ...
    it "redirects to the updated sponsored post" do
      ...
      put :update, params: { topic_id: my_topic.id, id: my_sponsored_post.id, sponsored_post: {title: new_title, body: new_body, price: 999 } }
  ...
  describe "DELETE destroy" do
    ...
    it "redirect to topic sponsored show" do
      delete :destroy, params: { topic_id: my_topic.id, id: my_sponsored_post.id }
